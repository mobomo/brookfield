  ...
  return (
    <div className='flex flex-col text-center justify-center items-center'>
          ...
          <div className='flex flex-col gap-3'>
              <Opacity delay={1000} duration={2000} twstyles={'flex text-white text-3xl  w-9775 text-center font-semibold font-opensans leading-9'}>
              ...
              <Opacity delay={1000} duration={2000} twstyles='items-center  flex gap-3 w-full justify-center'>
          ...
          <div className='flex w-full  justify-center gap-10 -mt-32'>
              <Opacity delay={1000} duration={1000} twstyles='flex flex-col w-97  justify-center text-left gap-3'>
              ...
              <Opacity delay={500} duration={1000} twstyles={''}>
                <Animation3 />
              </Opacity>
          </div>

          <Opacity delay={1000} duration={1000} twstyles='-mt-24 ml-10'>
