  ...
  return (
    <div className='flex flex-col md:flex-row w-full md:w-auto items-center'>
      ...
      <div className='flex flex-col -mt-10 md:mt-0  md:w-97 w-full'>
        <div className={'flex flex-col w-full md:w-97 justify-center text-left gap-3 mb-20'}>
                  <div className='flex text-white md:text-4.75xl text-xl font-mediumplus font-playfair'>
                    Another way to invest with Brookfield
                  </div>
                  <div className='flex text-white md:text-base text-ms  font-semibold md:text-xl'>
        ...
        <div className='md:mb-0 -mt-20 md:-mt-5 flex justify-center md:justify-start'>
